...
moveHandle(){
echo choose a move
echo move1place mark one empty cell
echo move2remove mark
echo move3exchange row
echo move4exchane column
echo move5exchange position
read move
case $move
in
1)move1;;
...
if [ $gameType -eq 1 ]
then
echo  enter the dimention of the grid, options are3,4,5
read dim
